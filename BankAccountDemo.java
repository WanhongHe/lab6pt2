...
/**
 *Program Description
 * 1)This program tests the BankAccount class by allowing the user
 * 2)to choose between whole dollar or currency mode, then process
 * 3)deposits, withdrawals, and interest for several months.
 *
 * @author Wanhong He
 * @version v1.0
 * @since 2025-10-18
